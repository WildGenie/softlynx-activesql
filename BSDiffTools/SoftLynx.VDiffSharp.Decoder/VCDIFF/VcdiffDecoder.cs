...
namespace SoftLynx.VDiffSharp
{
	...
	/// </summary>
	public sealed class VDiffDecoder
	{
		#region Fields
		/// <summary>
		...
		/// outside the class.
		/// </summary>
        VDiffDecoder(Stream original, Stream delta, Stream output)
		{
		...
		public static void Decode (Stream original, Stream delta, Stream output)
		{
            ...
            VDiffDecoder instance = new VDiffDecoder(original, delta, output);
			instance.Decode();
		}
		...
		void ReadCodeTable()
		{
			...
			VDiffDecoder.Decode(tableOriginal, tableDelta, tableOutput);
